...
gulp.task('watch', function (){
    ...
    gulp.watch([path.join(PATHS.app_html, '*.html'), path.join(PATHS.app_htmlTemplates, '**/*.html')], ['fileinclude'])
...
gulp.task('default', ['watch', 'fileinclude', 'js-bundle', 'styles', 'browser-sync', 'nodemon']);
